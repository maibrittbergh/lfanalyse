...
#'
#' @description A trend is calculated for the annual/seasonal minimum values values using Sen's Slope Estimator and linear regression. The result can be output in the form of a graph or in the form of a list.
#'
