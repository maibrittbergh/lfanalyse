...
#'@description Function visualizes a low flow period within a given (hydrological/calendrical) year. It returns a table or a graphic, displaying the threshold based low flow period of a station.
#'
...
#'
#' @examples
#' \dontrun{threshploty(data, "COCHEM", 150, 2000, graph = T)}

threshploty=function(data, station, U,year, graph=T){
